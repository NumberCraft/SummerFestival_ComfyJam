...
public class DataPersistenceManager : MonoBehaviour
{
    ...
    [SerializeField] private bool enableAutosave;
    ...
    public void LoadGame()
    {
        ...
        {
            //Debug.Log("The Data Persistence Objects are null!");
            return;
        }
    ...
    public void SaveGame()
    {
        ...
        dataHandler.SaveGame(this.gameData, selectedProfileId);
    }
    ...
    public void SaveSettings(SettingsData settingsData)
    {
        ...
        // timestamp the data so we know when it was last saved
        this.settingsData.lastUpdated = System.DateTime.Now.ToBinary();

        // save that data to a file using the data handler
        dataHandler.SaveSettings(this.settingsData, selectedProfileId);
    }

    public void LoadSettings(ref SettingsData settingsData)
    {
        // return right away if data persistence is disabled
        if (disableDataPersistence)
        {
        ...
        // load any saved data from a file using the data handler
        this.settingsData = dataHandler.LoadSettings(selectedProfileId);
    ...
    public string LoadMostRecentlyUpdatedProfileId()
    {
